    ...
    <div class="container py-5">
        ...
        <div class="row g-3 mb-5 fs-4 justify-content-center">        
            <div class="form-check col-5 wow zoomIn " data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: zoomIn;">
                <input class="form-check-input" type="checkbox" id="w1" name="futurtrait[]" value="Drought resistance">
                <label class="form-check-label" for="w1">Drought resistance</label>
            </div>
            <div class="form-check col-5 wow zoomIn " data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: zoomIn;">
                <input class="form-check-input" type="checkbox" id="w2" name="futurtrait[]" value="Nutrition/quality enhancing">
                <label class="form-check-label" for="w2">Nutrition/quality enhancing</label>
            </div>
            <div class="form-check col-5 wow zoomIn " data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: zoomIn;">
                <input class="form-check-input" type="checkbox" id="w3" name="futurtrait[]" value="Resistance to other diseases">
                <label class="form-check-label" for="w3">Resistance to other diseases</label>
            </div>
            <div class="form-check col-5 wow zoomIn " data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: zoomIn;">
                <input class="form-check-input" type="checkbox" id="w4" name="futurtrait[]" value="Yield enhancing">
                <label class="form-check-label" for="w4">Yield enhancing</label>
            </div>
            <div class="form-check col-5 wow zoomIn " data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: zoomIn;">
                <input class="form-check-input" type="checkbox" id="w5" name="futurtrait[]" value="Salinity tolerance">
                <label class="form-check-label" for="w5">Salinity tolerance</label>
            </div>
            <div class="form-check col-5 wow zoomIn " data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: zoomIn;">
                <input class="form-check-input" type="checkbox" id="w6" name="futurtrait[]" value="Resistance to insect pests">
                <label class="form-check-label" for="w6">Resistance to insect pests</label>
            </div>
            <div class="form-check col-5 wow zoomIn " data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: zoomIn;">
                <input class="form-check-input" type="checkbox" id="w7" name="futurtrait[]" value="Heat tolerance">
                <label class="form-check-label" for="w7">Heat tolerance</label>
            </div>
            <div class="form-check col-5 wow zoomIn " data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: zoomIn;">
                <input class="form-check-input" type="checkbox" id="w8" name="futurtrait[]" value="Tolerance to waterlogging">
                <label class="form-check-label" for="w8">Tolerance to waterlogging</label>
            </div>
            <div class="form-check col-5 wow zoomIn " data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: zoomIn;">
                <input class="form-check-input" type="checkbox" id="w9" name="futurtrait[]" value="Resistance to other pests">
            ...
            <div class="col-5 wow zoomIn " data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: zoomIn;">
                <input type="text" class="form-control fs-5" name="futurtrait[]" placeholder="Other traits">
            </div>
        </div>
        <div class="section-title text-center position-relative pb-3 my-3 mx-auto" style="max-width: 800px;">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-2 fs-4">
              <input type="number" class="form-control" id="inputText" name="percent" min="0" max="100" value="{{old('percent')}}">
            </div>
